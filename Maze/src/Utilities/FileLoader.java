...
/**
 * This class is responsible for the formatting of URL's and returning file
 * objects
 *
...
public class FileLoader {
    ...
    /**
     * Takes the name of an image file as a string and formats the corresponding
     * URL
     *
    ...
    /**
     * Takes the name of a sound file as a string and formats the corresponding
     * URL
     *
     * @param name The name of that is looked up
    ...
    /**
     * Takes the name for a save file as a string. The method creates a new file
     * with that name if said file does not aleadu exist
     *
    ...
    /**
     * Takes the name of a text file as a string and formats the corresponding
     * URL
     *
    ...
    /**
     * Returns a File object for the high score file for this application
     *
